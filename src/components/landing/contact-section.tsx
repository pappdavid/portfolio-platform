      ...
      <div ref={ref} className='dp-wrap dp-animate'>
        <div className='grid grid-cols-1 items-start gap-20 lg:grid-cols-2'>
          ...
          <div>
            ...
            <h2
              className='t-h2'
              style={{ color: 'var(--ink-0)', marginBottom: 20 }}
            >
              Let&apos;s build
              <br />
            ...
            >
              Open to junior AI / automation engineer or data science roles in
              the Netherlands.
            </p>
            <div
          ...
          >
            {CHANNELS.map((ch) => (
              ...
              >
                <div
                  style={{
                    color: ch.primary ? 'var(--accent)' : 'var(--ink-3)',
                    flexShrink: 0
                  }}
                >
                ...
                <span
                  style={{
                    fontFamily: 'var(--font-dp-mono)',
                    fontSize: 11,
                    color: ch.primary ? 'var(--accent-bright)' : 'var(--ink-3)',
                    flexShrink: 0
                  }}
                >
                  {ch.cta}
